...
export default function HeatmapScreen() {
  ...
  // Generate heatmap
  const { heatmap, isReady, queryCell } = useHeatmap({
    ...
    return (
      <ScreenSafeAreaView style={shared.container}>
        <View style={styles.header}>
          ...
          />
          <Text
            style={[styles.headerTitle, systemIsDark && styles.headerTitleDark]}
          >
        ...
        <View style={styles.emptyContainer}>
          ...
          />
          <Text
            style={[styles.emptyTitle, systemIsDark && styles.emptyTitleDark]}
          >
            {t("heatmapScreen.noActivityData")}
          </Text>
          <Text
            style={[styles.emptyText, systemIsDark && styles.emptyTextDark]}
          >
