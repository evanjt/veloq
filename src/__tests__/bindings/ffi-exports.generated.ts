...
export const FFI_EXPORTS: FfiExportInfo[] = [
  ...
  {
    name: 'run_detector_cutover',
    camelName: 'runDetectorCutover',
    file: 'ffi.rs',
    line: 588,
    paramCount: 0,
    returnType: 'Result<String, crate::VeloqError>',
  ...
  {
    name: 'restore_from_cutover_archive',
    camelName: 'restoreFromCutoverArchive',
    file: 'ffi.rs',
    line: 597,
    paramCount: 0,
...
export const RUST_TO_TS_NAME: Record<string, string> = {
  ...
  run_detector_cutover: 'runDetectorCutover',
  restore_from_cutover_archive: 'restoreFromCutoverArchive',
