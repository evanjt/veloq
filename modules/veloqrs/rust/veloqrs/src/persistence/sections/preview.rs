...
mod tests {
    ...
    /// The identity property `I85` turns on: a catalogue diffed against itself
    /// is entirely unchanged. Anything else is the pairing rather than the
    /// detector, and a device run reporting 89 gone of 118 would then be a
    /// defect here rather than a different cut.
    ///
